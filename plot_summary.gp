...
#plot './kk_beta_mpi.dat' i 0 u ($2**2)*r0_A2:13:($13-$14-$15):($13+$14+$16) ls 5 w errorbars notitle,\
#'./kk_beta_mpi.dat' i 1 u ($2**2)*r0_A2:13:($13-$14-$15):($13+$14+$16) w errorbars ls 1 notitle,\
#'./kk_beta_mpi.dat' i 2 u ($2**2)*r0_A2:13:($13-$14-$15):($13+$14+$16) w errorbars ls 4 notitle,\
#'./kk_beta_mpi.dat' i 3 u ($2**2)*r0_B2:13:($13-$14-$15):($13+$14+$16) w errorbars ls 2 notitle,\
#'./kk_beta_mpi.dat' i 4 u ($2**2)*r0_D2:13:($13-$14-$15):($13+$14+$16) w errorbars ls 3 notitle
#
#replot './kk_beta_mpi.dat' i 0 u ($2**2)*r0_A2:13:14 w yerr ls 5 t 'b1.90, mu_s = 0.0185',\
#'./kk_beta_mpi.dat' i 1 u ($2**2)*r0_A2:13:14 w yerr ls 1 t 'b1.90, mu_s = 0.0225',\
#'./kk_beta_mpi.dat' i 2 u ($2**2)*r0_A2:13:14 w yerr ls 4 t 'b1.90, mu_s = 0.02464',\
#'./kk_beta_mpi.dat' i 3 u ($2**2)*r0_B2:13:14 w yerr ls 2 t 'b1.95, mu_s = 0.01860',\
#'./kk_beta_mpi.dat' i 4 u ($2**2)*r0_D2:13:14 w yerr ls 3 t 'b2.10, mu_s = 0.01500'
