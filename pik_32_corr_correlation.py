...
def main():
    ...
    if do_e3 is True:
        ...
        print e3_corr_ws.data.shape
        plotter = ana.LatticePlot(plotdir+'/'+'epik_corr_plot.pdf')
        plotter.plot_correlation(e3_corr_ws.data[...,0].T,[r'$E_{\pi K}$','E3'])
        plotter.plot_correlation(e1_corr_ws.data[...,0].T,[r'$E_{\pi K}$','E1'])
        del plotter
