set title "K K Scattering length match to beta = 1.95"
set xlabel "(r_0 M_{Pi})^2"
set ylabel "M_Ka_0"
set xrange [0:1.5]
set yrange [-0.45:-0.26]
set grid
r0_A2=5.31**2
r0_B2=5.77**2
r0_D2=7.60**2
...
set out './kk_scat_matched_compare_mpi.pdf'
#plot 'test.dat' u 2:3:1 w labels point offset character 0,character 1
set arrow from (mpi_r0_phys**2),-0.45 to (mpi_r0_phys**2),-0.26 nohead
...
plot './kk_beta_matched.dat' i 0 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 1 w errorbars notitle, \
 ...
 './kk_beta_matched.dat.bkp' i 0 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 2 w errorbars notitle, \
 './kk_beta_matched.dat.bkp' i 0 u ($2**2)*r0_A2:9:10 w yerr ls 2 t 'b1.90, old \mu_s = 0.02125 (int.)'
...
plot './kk_beta_matched.dat' i 1 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 1 w errorbars notitle, \
 ...
 './kk_beta_matched.dat.bkp' i 1 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 2 w errorbars notitle, \
 './kk_beta_matched.dat.bkp' i 1 u ($2**2)*r0_A2:9:10 w yerr ls 2 t 'b1.90, old \mu_s = 0.02125 (ext.)'
...
plot './kk_beta_matched.dat' i 0 u ($2**2)*r0_A2:($10*(-1)/$9):13 w labels point offset 0,1 notitle, \
 ...
 './kk_beta_matched.dat.bkp' i 0 u ($2**2)*r0_A2:($10*(-1)/$9) ls 2 t 'b1.90, old \mu_s = 0.02125 (int.)'
...
plot './kk_beta_matched.dat' i 1 u ($2**2)*r0_A2:($10*(-1)/$9):13 w labels point offset 0,-1 notitle, \
 ...
 './kk_beta_matched.dat.bkp' i 1 u ($2**2)*r0_A2:($10*(-1)/$9)ls 2 t 'b1.90, old \mu_s = 0.02125 (ext.)'

#plot './kk_beta_matched.dat' i 0 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 1 w errorbars notitle, \
# './kk_beta_matched.dat' i 1 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 4 w errorbars notitle, \
# './kk_beta_matched.dat' i 2 u ($2**2)*r0_B2:9:($9-$10-$12):($9+$10+$11) ls 2 w errorbars notitle, \
# './kk_beta_matched.dat' i 3 u ($2**2)*r0_D2:9:($9-$10-$12):($9+$10+$11) ls 3 w errorbars notitle, \
# './kk_beta_matched.dat' i 1 u ($2**2)*r0_A2:9:13 w labels point offset 0,-3 notitle, \
...
#
## Plot extrapolation
#plot './kk_beta_matched.dat' i 1 u ($2**2)*r0_A2:9:($9-$10-$12):($9+$10+$11) ls 4 w errorbars notitle, \
# './kk_beta_matched.dat' i 2 u ($2**2)*r0_B2:9:($9-$10-$12):($9+$10+$11) ls 2 w errorbars notitle, \
# './kk_beta_matched.dat' i 3 u ($2**2)*r0_D2:9:($9-$10-$12):($9+$10+$11) ls 3 w errorbars notitle, \
# './kk_beta_matched.dat' i 1 u ($2**2)*r0_A2:9:10 w yerr ls 4 t 'b1.90, \mu_s = 0.02125 (ext.)', \
# './kk_beta_matched.dat' i 2 u ($2**2)*r0_B2:9:10 w yerr ls 2 t 'b1.95, \mu_s = 0.0186', \
