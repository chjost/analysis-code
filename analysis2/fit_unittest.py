...
class FitResult_Test(unittest.TestCase):
    ...
    #    chi2 = np.ones((10,))
    #    pval = np.ones((10,))
    #    fr.create_empty((10, 25, 4), (10, 4), [3, 2])
    #    self.assertRaises(ValueError, fr.add_data, (1,), res, chi2, pval)
    #    self.assertRaises(ValueError, fr.add_data, (4,0,0), res, chi2, pval)
    #    self.assertRaises(ValueError, fr.add_data, (0,3,0), res, chi2, pval)
    #    self.assertRaises(ValueError, fr.add_data, (0,0,5), res, chi2, pval)
    #    fr.add_data((0,0,0), res, chi2, pval)
    #    self.assertTrue(np.array_equal(fr.data[0][:,:,0], np.ones((10, 25))))
    #    self.assertTrue(np.array_equal(fr.chi2[0][:,0], np.ones((10,))))
    #    fr.add_data((2,1,0), res, chi2, pval)
    #    self.assertTrue(np.array_equal(fr.data[5][:,:,0], np.ones((10, 25))))
    #    self.assertTrue(np.array_equal(fr.chi2[5][:,0], np.ones((10,))))
    #    fr.add_data((0,0,3), res, chi2, pval)
    #    self.assertTrue(np.array_equal(fr.data[0][:,:,3], np.ones((10, 25))))
    #    self.assertTrue(np.array_equal(fr.chi2[0][:,3], np.ones((10,))))
    #    fr.add_data((2,1,3), res, chi2, pval)
    #    self.assertTrue(np.array_equal(fr.data[5][:,:,3], np.ones((10, 25))))
