...
class ExtDat(object):
    ...
    def __init__(self, seeds, space, zp_meth, nboot=1500):
        ...
        if zp_meth == 1:
            ...
            obs_a = {'r0':(5.31,0.08),'zp':(0.574,0.004),'zp/zs':(0.651,0.006)}
            obs_b = {'r0':(5.77,0.06),'zp':(0.546,0.002),'zp/zs':(0.666,0.004)}
            obs_d = {'r0':(7.60,0.08),'zp':(0.545,0.002),'zp/zs':(0.727,0.003)}
    ...
    def __init__(self,seeds,zp_meth=None,nboot=1500):
        ...
        if zp_meth == 1:
            ...
            obs = {'r0':(0.470,0.012),'mk':(494.2,0.3),'mpi_0':(134.8,0.3),
                  'm_l':(3.7,0.17), 'fpi':(130.50,0.13), 'meta':(574.862,0.017),
                  'b0':(2515,90),'l4':(4.69,0.1)}
